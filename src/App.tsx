      ...
      <div className={'min-h-lvh w-full bg-background'}>
        ...
        <div className="mx-auto grid max-mobile:p-3 tablet:place-items-center place-content-center gap-4 container" {...handlers}
          ...
          <div className={'flex flex-col gap-4 '}>
            <img srcSet={`${logo_small} 500w, ${logo} 1000w`} src={logo} height={847} width={1469} sizes="(max-width: 500px) 500px, (max-width: 1000px) 1000px, 2000px" className="w-full rounded shadow-[8px_8px_0px_rgba(0,0,0,1)]" alt="logo">
